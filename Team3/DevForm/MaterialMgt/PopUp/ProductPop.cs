    ...
    public partial class ProductPop : Team3.DialogForm
    {
        ...
        {            
            ...
            if(edit == EditMode.Update)
            {
                ...
                cboProductType.SelectedValue = vo.product_type_value;
        ...
        private void FormatingErr(string vo)
        {
            vo = "";
        }
            ...
            if (edit == EditMode.Insert)
            {
                if (MessageBox.Show("등록하시겠습니까?", "신규등록", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        vo.product_in_sector = cboInSector.SelectedValue.ToString();
                        vo.product_out = cboOutSector.SelectedValue.ToString();
                        ...
                        vo.product_admin = cboAdmin.SelectedValue.ToString();
                        vo.product_ordertype = cboOrderType.SelectedValue.ToString();
                        vo.product_yn = cboIsUsed.SelectedValue.ToString();
                        vo.product_supply_com = cboSupplyCompany.SelectedValue.ToString();
                        vo.product_demand_com = cboDemandCompany.SelectedValue.ToString();
